...
const resumes_repository_1 = require("./repository/resumes.repository");
...
exports.ResumesModule = ResumesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [resumes_service_1.ResumesService, resumes_repository_1.ResumesRepository],
        exports: [resumes_repository_1.ResumesRepository],
    })
], ResumesModule);
